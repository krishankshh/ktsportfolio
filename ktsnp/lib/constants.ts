...
export const EXPERIENCE = [
  ...
  },
  {
    ...
    period: "Sep'21 - Jun'23",
    description: "Teaching programming languages such as Python and Java to students of various age groups, focusing on fundamentals, problem-solving, and project development.",
    achievements: [
    ...
    technologies: ["Python", "Java", "Data Structures", "Algorithms", "C & C++"]
  },
  {
    title: "Mentor & Coding Tutor",
    company: "Nibodh & Thakur Polytechnic",
    location: "India, Mumbai",
    period: "Jul'22 - Sep'22",
    description: "Guiding diploma students in understanding programming concepts, debugging code, and completing assignments in languages like Python and Java.",
    achievements: [
      "Mentored 50+ students in programming",
      "Helped students improve coding skills and confidence",
      "Assisted in project development and problem-solving",
    ],
...
export const EDUCATION = [
  {
    ...
    institution: "Thakur College of Engineering & Technology", // Update with your university
    location: "India",
    period: "2022 - 2025",
  ...
  },
  {
    ...
    institution: "Shri Bhagubhai Mafatlal Polytechnic", // Update with your institute
    location: "India",
    period: "2019 - 2022",
...
export const CERTIFICATIONS = [
  ...
  "Cybersecurity Basics",  // Add your actual certifications here
];
